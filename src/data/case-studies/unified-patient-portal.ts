...
export const unifiedPatientPortal: CaseStudy = {
  ...
  previewVideos: [
    "https://player.vimeo.com/video/1169731248?autoplay=1&loop=1&muted=1&background=1#t=0s",
    "https://player.vimeo.com/video/1169731248?autoplay=1&loop=1&muted=1&background=1#t=100s",
    "https://player.vimeo.com/video/1169731248?autoplay=1&loop=1&muted=1&background=1#t=200s",
  ],
