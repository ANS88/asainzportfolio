  ...
  return (
    <section>
      ...
      <div className="map-wrap">
        ...
        >
          {/* Connection lines */}
          <g stroke="#4a2d6b" strokeWidth="1.5" fill="none">
            ...
            {/* Satellites */}
            <line x1="600" y1="130" x2="630" y2="505" stroke="#3a1d55" />
            <line x1="630" y1="505" x2="200" y2="130" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="630" y1="505" x2="540" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="630" y1="505" x2="445" y2="505" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="600" y1="130" x2="710" y2="55" stroke="#3a1d55" />
            <line x1="710" y1="55" x2="540" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="200" y1="130" x2="150" y2="320" stroke="#3a1d55" />
            <line x1="150" y1="320" x2="48" y2="380" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="150" y1="320" x2="260" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="80" y1="215" x2="260" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="260" y1="450" x2="600" y2="130" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="200" y1="130" x2="80" y2="215" stroke="#3a1d55" />
            <line x1="80" y1="215" x2="48" y2="380" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="600" y1="130" x2="48" y2="380" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="650" y1="320" x2="48" y2="380" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="200" y1="130" x2="48" y2="380" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="600" y1="130" x2="700" y2="180" stroke="#3a1d55" />
            <line x1="700" y1="180" x2="710" y2="55" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="700" y1="180" x2="650" y2="320" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="700" y1="180" x2="540" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="650" y1="320" x2="768" y2="300" stroke="#3a1d55" />
            <line x1="768" y1="300" x2="540" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="768" y1="300" x2="600" y2="130" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="650" y1="320" x2="750" y2="415" stroke="#3a1d55" />
            <line x1="750" y1="415" x2="540" y2="450" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="750" y1="415" x2="600" y2="130" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="650" y1="320" x2="752" y2="250" stroke="#3a1d55" />
            <line x1="600" y1="130" x2="752" y2="250" stroke="#3a1d55" />
            <line x1="540" y1="450" x2="752" y2="250" stroke="#3a1d55" />
            <line x1="200" y1="130" x2="752" y2="250" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="540" y1="450" x2="445" y2="505" stroke="#3a1d55" />
            <line x1="600" y1="130" x2="445" y2="505" stroke="#3a1d55" strokeDasharray="4,4" />
            <line x1="650" y1="320" x2="445" y2="505" stroke="#3a1d55" />
            <line x1="200" y1="130" x2="445" y2="505" stroke="#3a1d55" strokeDasharray="4,4" />
          </g>
          ...
          {SATELLITE_NODES.map((s) => (
            <g key={Array.isArray(s.label) ? s.label.join(" ") : s.label} className="satellite-node" style={{ transformOrigin: `${s.cx}px ${s.cy}px` }}>
              <circle cx={s.cx} cy={s.cy} r="28" fill="#230c33" stroke="#4a2d6b" />
              {Array.isArray(s.label) ? (
                <>
                  <text x={s.cx} y={s.cy - 3} textAnchor="middle" fill="#7a6aad" fontSize="10" fontFamily="Inter, sans-serif">{s.label[0]}</text>
                  <text x={s.cx} y={s.cy + 9} textAnchor="middle" fill="#7a6aad" fontSize="10" fontFamily="Inter, sans-serif">{s.label[1]}</text>
                </>
              ) : (
                <text x={s.cx} y={s.cy + 4} textAnchor="middle" fill="#7a6aad" fontSize="10" fontFamily="Inter, sans-serif">{s.label}</text>
              )}
            </g>
          ))}
          ...
          {PRIMARY_NODES.map((node) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <circle cx={node.cx} cy={node.cy} r={r + 10} fill="none" stroke="#c4a8f0" strokeWidth="1.5" opacity=".3" className="pulse-ring" />
                )}
                <circle cx={node.cx} cy={node.cy} r={r} fill={isExpanded ? "#c4a8f0" : "#2a1239"} stroke="#c4a8f0" strokeWidth="2" className="node-circle" />
                {node.label.length === 2 ? (
                  <>
                    <text x={node.cx} y={node.cy - 8} textAnchor="middle" fill={isExpanded ? "white" : "#c4a8f0"} fontSize="13" fontWeight="400" fontFamily="Inter, sans-serif">{node.label[0]}</text>
                    <text x={node.cx} y={node.cy + 8} textAnchor="middle" fill={isExpanded ? "white" : "#c4a8f0"} fontSize="13" fontWeight="400" fontFamily="Inter, sans-serif">{node.label[1]}</text>
                  </>
                ) : (
                  <text x={node.cx} y={node.cy + 5} textAnchor="middle" fill={isExpanded ? "white" : "#c4a8f0"} fontSize="13" fontWeight="400" fontFamily="Inter, sans-serif">{node.label[0]}</text>
                )}
              </g>
            );
          })}
          ...
          <g className="center-node" style={{ transformOrigin: "400px 260px" }}>
            <circle cx="400" cy="260" r="56" fill="#c4a8f0" stroke="#8a6ebf" strokeWidth="2.5" />
            <text x="400" y="253" textAnchor="middle" fill="white" fontSize="16" fontWeight="400" fontFamily="Inter, sans-serif">Adriana</text>
            <text x="400" y="273" textAnchor="middle" fill="#8a6ebf" fontSize="11" fontFamily="Inter, sans-serif">PhD &middot; Builder &middot; SF</text>
          </g>
        </svg>
      ...
      <div className="social-grid">
        ...
        <a href="https://www.linkedin.com/in/adrianans/" target="_blank" rel="noopener noreferrer" className="social-card">
          <div className="sc-icon" style={{ background: "#c4a8f0" }}>in</div>
        ...
        <a href="https://womenshealthcomputed.substack.com" target="_blank" rel="noopener noreferrer" className="social-card">
          <div className="sc-icon" style={{ background: "#c4a8f0" }}>✎</div>
          <div className="sc-body">
        ...
        <a href="https://scholar.google.com/citations?user=6ec-wJ8AAAAJ" target="_blank" rel="noopener noreferrer" className="social-card">
          <div className="sc-icon" style={{ background: "#c4a8f0" }}>G</div>
          <div className="sc-body">
        ...
        <a href="https://www.athenadao.co/" target="_blank" rel="noopener noreferrer" className="social-card">
          <div className="sc-icon" style={{ background: "#c4a8f0" }}>Ξ</div>
          <div className="sc-body">
        ...
        <a href="mailto:sainz.nag@gmail.com" className="social-card">
          <div className="sc-icon" style={{ background: "#9984d4" }}>@</div>
          <div className="sc-body">
