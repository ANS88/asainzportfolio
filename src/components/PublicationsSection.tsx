...
const pubs = [
  ...
  { name: "Unified Patient Portal: Engaging patients throughout the genetic testing journey", where: "DRS 2025", href: "https://scholar.google.com/citations?view_op=view_citation&hl=en&user=6ec-wJ8AAAAJ&citation_for_view=6ec-wJ8AAAAJ:roLk4NBRz8UC" },
