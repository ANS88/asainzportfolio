        ...
        <h1>
          ...
          <span className="hero-app-links">
            <a href="mailto:sainz.nag@gmail.com" className="hero-app-icon" aria-label="Email">
              <svg viewBox="0 0 16 12" fill="currentColor"><rect x="0" y="0" width="16" height="12"/><rect x="2" y="0" width="2" height="2" fill="var(--paper)"/><rect x="12" y="0" width="2" height="2" fill="var(--paper)"/><rect x="4" y="2" width="2" height="2" fill="var(--paper)"/><rect x="10" y="2" width="2" height="2" fill="var(--paper)"/><rect x="6" y="4" width="4" height="2" fill="var(--paper)"/></svg>
            </a>
            <a href="https://www.linkedin.com/in/adrianans/" target="_blank" rel="noopener noreferrer" className="hero-app-icon" aria-label="LinkedIn">
              <svg viewBox="0 0 14 14" fill="currentColor"><rect x="1" y="0" width="2" height="2"/><rect x="1" y="4" width="2" height="10"/><rect x="5" y="2" width="2" height="12"/><rect x="7" y="2" width="2" height="2"/><rect x="9" y="2" width="2" height="12"/></svg>
            </a>
            ...
            <a href="https://github.com/ANS88" target="_blank" rel="noopener noreferrer" className="hero-app-icon" aria-label="GitHub">
              <svg viewBox="0 0 16 16" fill="currentColor">{/* Circle */}<rect x="4" y="0" width="8" height="2"/><rect x="2" y="2" width="4" height="2"/><rect x="10" y="2" width="4" height="2"/><rect x="0" y="4" width="4" height="2"/><rect x="12" y="4" width="4" height="2"/><rect x="0" y="6" width="2" height="4"/><rect x="14" y="6" width="2" height="4"/><rect x="0" y="10" width="4" height="2"/><rect x="12" y="10" width="4" height="2"/><rect x="2" y="12" width="4" height="2"/><rect x="10" y="12" width="4" height="2"/><rect x="4" y="14" width="8" height="2"/>{/* Cat silhouette cutout */}<rect x="4" y="2" width="2" height="2" fill="var(--paper)"/><rect x="10" y="2" width="2" height="2" fill="var(--paper)"/><rect x="4" y="4" width="2" height="2" fill="var(--paper)"/><rect x="10" y="4" width="2" height="2" fill="var(--paper)"/><rect x="6" y="4" width="4" height="2" fill="var(--paper)"/><rect x="6" y="6" width="4" height="6" fill="var(--paper)"/><rect x="4" y="6" width="2" height="2" fill="var(--paper)"/><rect x="10" y="6" width="2" height="2" fill="var(--paper)"/><rect x="2" y="10" width="2" height="2" fill="var(--paper)"/><rect x="4" y="10" width="2" height="4" fill="var(--paper)"/><rect x="10" y="10" width="2" height="4" fill="var(--paper)"/></svg>
            </a>
          </span>
        </h1>
      </AnimateOnScroll>
