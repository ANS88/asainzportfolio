        ...
        <h1>
          ...
          <span className="hero-app-links">
            ...
            <a href="https://github.com/ANS88" target="_blank" rel="noopener noreferrer" className="hero-app-icon" aria-label="GitHub">
              <svg viewBox="0 0 16 16" fill="currentColor"><rect x="2" y="0" width="2" height="4"/><rect x="12" y="0" width="2" height="4"/><rect x="4" y="2" width="8" height="2"/><rect x="2" y="4" width="12" height="6"/><rect x="4" y="10" width="8" height="2"/><rect x="6" y="12" width="4" height="2"/><rect x="4" y="6" width="2" height="2" fill="var(--paper)"/><rect x="10" y="6" width="2" height="2" fill="var(--paper)"/></svg>
            </a>
          </span>
        </h1>
      </AnimateOnScroll>
